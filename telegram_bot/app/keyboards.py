...
contacts = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Telegram разработчика бота",
                          url="https://t.me/Necro_Phosphorite")],
    [InlineKeyboardButton(text="VK разработчика бота",
                          url="https://vk.com/necro_phosphorite")],
    [InlineKeyboardButton(text="Telegram ML-разработчика",
                          url="https://t.me/Necro_Phosphorite")],
    [InlineKeyboardButton(text="Назад", callback_data="back")]
])
